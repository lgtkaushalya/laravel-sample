...
<div class="m-auto pt-20">
    <div class="pb-8">
        @if ($errors->any())
            ...
            <ul class="barder border-t-0 border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700">
    ...
    <form
        ...
        <input
            ...
            name="title"
            placeholder="Title..."
            class="bg-transparent block border-b-2 w-full h-20 text-2xl outline-none" value="{{ $post->title }}">
        ...
        <input
            ...
            class="bg-transparent block border-b-2 w-full h-20 text-2xl outline-none" value="{{ $post->min_to_read }}">
